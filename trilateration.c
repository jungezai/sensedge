...
distance_struct_t distanceArray[4];


anc_struct_t ancArray[4];
	...
	int *combination)
{
	...
	int		success, concentric, result,i=10;
...
int calculateTagLocation(vec3d *report, int count, distance_struct_t *ranges)
{
	int result = 0;
	vec3d anchorArray[4];
	int _distanceArray[4];

	anchorArray[0].x = ancArray[0].x;
	anchorArray[0].y = ancArray[0].y;
	anchorArray[0].z = ancArray[0].z;

	anchorArray[1].x = ancArray[1].x;
	anchorArray[1].y = ancArray[1].y;
	anchorArray[1].z = ancArray[1].z;

	anchorArray[2].x = ancArray[2].x;
	anchorArray[2].y = ancArray[2].y;
	anchorArray[2].z = ancArray[2].z;

	anchorArray[3].x = ancArray[3].x;
	anchorArray[3].y = ancArray[3].y;
	anchorArray[3].z = ancArray[3].z;
